    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="http://localhost:3359about.html"><span>About Us</span></a></li>
          <li><a href="http://localhost:3359/blog.html"><span>Blog</span></a></li>
          <li><a href="http://localhost:3359/contact.html"><span>Contact Us</span></a></li>
        </ul>
      </div>
      <div class="logo">
    ...
    <asp:HiddenField ID="HiddenField2" runat="server" />
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="http://localhost:3359/login.aspx">Home</a></li>
            <li><a href="http://localhost:3359/about.html">TemplateInfo</a></li>
            <li><a href="http://localhost:3359/blog.html">blog</a></li>
            <li><a href="http://localhost:3359/abot.html">contact</a></li>
          </ul>
        </div>
        <div class="gadget">
          <div class="clr"></div>

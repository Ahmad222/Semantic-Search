...
namespace Searcharoo.Common
{
    ...
    public class Catalog
    {
        ...
        public void clear()
        {
            ...
            {
                string kk = @"<?xml version=""1.0"" encoding=""utf-8""?>
<Catalog xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  ...
  <f u=""http://localhost:3359/"" t="""" d=""2013-12-30T12:59:08.7809383-08:00"" s=""266"">
    <d>Search Page</d>
  </f>
</Catalog>";
                TextWriter tsw = new StreamWriter(@"C:\Inetpub\CodeProject.com\Searcharoo5\WebApplication\z_searcharoo.xml");
                tsw.WriteLine(kk);
                tsw.Close();
            }
        }
